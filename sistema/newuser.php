                ...
                <p class="h5">Bem Vindo<p class="h6"><?php echo $_SESSION['usuario']['nome'];?></p></p>
                    ...
                    <div class="nav-dash-menu d-flex flex-column flex-shrink-0 p-4 ">
                        <ul class="nav nav-pills flex-column mb-auto">
                            <li class="nav-item"><a href="" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                        ...
                        <?php if($_SESSION['usuario']['cargo'] == 'administrador' || $_SESSION['usuario']['cargo'] == 'juiz'){?>
                            <li><a href="dashboardUser.php" class="nav-link active"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
