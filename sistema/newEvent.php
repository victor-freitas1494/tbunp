            ...
            <div class="nav-dash-user">
                ...
                <p class="h5">Bem Vindo<p class="h6"><?php echo $_SESSION['usuario']['nome'];?></p></p>
                    ...
                    <div class="nav-dash-menu d-flex flex-column flex-shrink-0 p-4 ">
                        ...
                        <?php }?>
                            <li><a href="evento.php" class="nav-link active"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
        ...
        <div class="container">
            <div class="row margem">            
                ...
                <div class="d-grid gap-2 mt-2">
                    <a href="evento.php" class="btn btn-secondary" role="button" aria-pressed="true" style="color: black;" id="btn_cancelar">Cancelar</a>
                </div>
